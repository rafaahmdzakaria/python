...
# Gesture "Perkenalkan" -> tangan terbuka
    if (thumb_tip < thumb_base and index_tip < index_base and middle_tip < index_base and ring_tip < index_base and pinky_tip < index_base):
        return "Halo"
    
# Gesture "Nama saya" -> jari telunjuk tegak
    if (index_tip < index_base and middle_tip > index_base and ring_tip > index_base and pinky_tip > index_base):
        return "Nama saya"

# Gesture "Nama" -> tangan mengepal
    if (index_tip > index_base and middle_tip > index_base and ring_tip > index_base and pinky_tip > index_base):
        return "Rafa"

# Gesture "Terimakasih" -> tanda love (telunjuk + kelingking)
    if (index_tip < index_base and pinky_tip < index_base and middle_tip > index_base and ring_tip > index_base):
        return "Terimakasih"
